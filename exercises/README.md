...
| `02-ros-package/` | That workspace, trimmed to Lyrical, with colcon doing the building | Pixi building the C++ and a Python package from their `package.xml`, no sourcing, no `build/` directory, an edit-run loop |
